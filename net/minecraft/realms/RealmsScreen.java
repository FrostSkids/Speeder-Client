...
public class RealmsScreen
{
    ...
    public void drawString(final String p_drawString_1_, final int p_drawString_2_, final int p_drawString_3_, final int p_drawString_4_, final boolean p_drawString_5_) {
