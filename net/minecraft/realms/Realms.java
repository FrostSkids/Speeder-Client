...
public class Realms
{
    ...
    public static ListenableFuture<Object> downloadResourcePack(final String p_downloadResourcePack_0_, final String p_downloadResourcePack_1_) {
        final ListenableFuture<Object> listenablefuture = Minecraft.getMinecraft().getResourcePackRepository().downloadResourcePack(p_downloadResourcePack_0_, p_downloadResourcePack_1_);
