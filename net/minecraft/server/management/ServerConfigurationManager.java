...
public abstract class ServerConfigurationManager
{
    ...
    public void initializeConnectionToPlayer(final NetworkManager netManager, final EntityPlayerMP playerIn) {
        ...
        ServerConfigurationManager.logger.info(String.valueOf(playerIn.getCommandSenderName()) + "[" + s2 + "] logged in with entity id " + playerIn.getEntityId() + " at (" + playerIn.posX + ", " + playerIn.posY + ", " + playerIn.posZ + ")");
    ...
    public String func_181058_b(final boolean p_181058_1_) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            s = String.valueOf(s) + list.get(i).getCommandSenderName();
            if (p_181058_1_) {
    ...
    public StatisticsFile getPlayerStatsFile(final EntityPlayer playerIn) {
        ...
        if (statisticsfile == null) {
            ...
            if (!file2.exists()) {
                final File file3 = new File(file1, String.valueOf(playerIn.getCommandSenderName()) + ".json");
