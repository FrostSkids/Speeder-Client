...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream
{
                ...
                public void run() {
                    try {
                        ...
                        if (JsonUtils.getBoolean(jsonobject2, "valid")) {
                            ...
                            TwitchStream.LOGGER.debug(TwitchStream.STREAM_MARKER, "Authenticated with twitch; username is {}", new Object[] { s2 });
    ...
    public void func_152922_k() {
        if (this.broadcastController.isBroadcasting() && !this.broadcastController.isBroadcastPaused()) {
            ...
            if (flag) {
                ...
                worldrenderer.func_181662_b(0.0, f2, 0.0).func_181673_a(0.0, f4).func_181675_d();
                worldrenderer.func_181662_b(f, f2, 0.0).func_181673_a(f3, f4).func_181675_d();
                worldrenderer.func_181662_b(f, 0.0, 0.0).func_181673_a(f3, 0.0).func_181675_d();
                worldrenderer.func_181662_b(0.0, 0.0, 0.0).func_181673_a(0.0, 0.0).func_181675_d();
                tessellator.draw();
    ...
    public void func_152911_a(final Metadata p_152911_1_, final long p_152911_2_) {
        if (this.isBroadcasting() && this.field_152957_i) {
            ...
            if (!this.broadcastController.func_152840_a(p_152911_1_.func_152810_c(), i + p_152911_2_, p_152911_1_.func_152809_a(), p_152911_1_.func_152806_b())) {
                TwitchStream.LOGGER.warn(TwitchStream.STREAM_MARKER, "Couldn't send stream metadata action at {}: {}", new Object[] { i + p_152911_2_, p_152911_1_ });
            }
            else {
                TwitchStream.LOGGER.debug(TwitchStream.STREAM_MARKER, "Sent stream metadata action at {}: {}", new Object[] { i + p_152911_2_, p_152911_1_ });
            }
        }
    }
    ...
    public void func_176026_a(final Metadata p_176026_1_, final long p_176026_2_, final long p_176026_4_) {
        if (this.isBroadcasting() && this.field_152957_i) {
            ...
            if (j < 0L) {
                TwitchStream.LOGGER.warn(TwitchStream.STREAM_MARKER, "Could not send stream metadata sequence from {} to {}: {}", new Object[] { i + p_176026_2_, i + p_176026_4_, p_176026_1_ });
            }
            else if (this.broadcastController.func_177947_a(p_176026_1_.func_152810_c(), i + p_176026_4_, j, s, s2)) {
                TwitchStream.LOGGER.debug(TwitchStream.STREAM_MARKER, "Sent stream metadata sequence from {} to {}: {}", new Object[] { i + p_176026_2_, i + p_176026_4_, p_176026_1_ });
            }
            else {
                TwitchStream.LOGGER.warn(TwitchStream.STREAM_MARKER, "Half-sent stream metadata sequence from {} to {}: {}", new Object[] { i + p_176026_2_, i + p_176026_4_, p_176026_1_ });
            }
        }
    }
    ...
    public void func_152930_t() {
        ...
        final VideoParams videoparams = this.broadcastController.func_152834_a(formatStreamKbps(gamesettings.streamKbps), formatStreamFps(gamesettings.streamFps), formatStreamBps(gamesettings.streamBytesPerPixel), this.mc.displayWidth / (float)this.mc.displayHeight);
        ...
        TwitchStream.LOGGER.info(TwitchStream.STREAM_MARKER, "Streaming at {}/{} at {} kbps to {}", new Object[] { videoparams.outputWidth, videoparams.outputHeight, videoparams.maxKbps, this.broadcastController.func_152833_s().serverUrl });
    ...
    public void func_152897_a(final ErrorCode p_152897_1_) {
        if (ErrorCode.succeeded(p_152897_1_)) {
            ...
            TwitchStream.LOGGER.warn(TwitchStream.STREAM_MARKER, "Login attempt unsuccessful: {} (error code {})", new Object[] { ErrorCode.getString(p_152897_1_), p_152897_1_.getValue() });
            this.loggedIn = false;
        }
    }
    ...
    public void func_152894_a(final StreamInfo p_152894_1_) {
        TwitchStream.LOGGER.debug(TwitchStream.STREAM_MARKER, "Stream info updated; {} viewers on stream ID {}", new Object[] { p_152894_1_.viewers, p_152894_1_.streamId });
    }
    ...
    public void func_152893_b(final ErrorCode p_152893_1_) {
        TwitchStream.LOGGER.warn(TwitchStream.STREAM_MARKER, "Issue submitting frame: {} (Error code {})", new Object[] { ErrorCode.getString(p_152893_1_), p_152893_1_.getValue() });
