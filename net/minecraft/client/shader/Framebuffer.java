...
public class Framebuffer
{
    ...
    public void framebufferRenderExt(final int p_178038_1_, final int p_178038_2_, final boolean p_178038_3_) {
        if (OpenGlHelper.isFramebufferEnabled()) {
            ...
            worldrenderer.func_181662_b(0.0, f2, 0.0).func_181673_a(0.0, 0.0).func_181669_b(255, 255, 255, 255).func_181675_d();
            worldrenderer.func_181662_b(f, f2, 0.0).func_181673_a(f3, 0.0).func_181669_b(255, 255, 255, 255).func_181675_d();
            worldrenderer.func_181662_b(f, 0.0, 0.0).func_181673_a(f3, f4).func_181669_b(255, 255, 255, 255).func_181675_d();
            worldrenderer.func_181662_b(0.0, 0.0, 0.0).func_181673_a(0.0, f4).func_181669_b(255, 255, 255, 255).func_181675_d();
            tessellator.draw();
            this.unbindFramebufferTexture();
