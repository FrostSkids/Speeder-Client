...
public class Shader
{
    ...
    public void loadShader(final float p_148042_1_) {
        ...
        worldrenderer.func_181662_b(0.0, f2, 500.0).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(f, f2, 500.0).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(f, 0.0, 500.0).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(0.0, 0.0, 500.0).func_181669_b(255, 255, 255, 255).func_181675_d();
        tessellator.draw();
