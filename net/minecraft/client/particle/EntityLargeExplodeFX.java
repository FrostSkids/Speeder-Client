...
public class EntityLargeExplodeFX extends EntityFX
{
    ...
    public void renderParticle(final WorldRenderer worldRendererIn, final Entity entityIn, final float partialTicks, final float p_180434_4_, final float p_180434_5_, final float p_180434_6_, final float p_180434_7_, final float p_180434_8_) {
        ...
        if (i <= 15) {
            ...
            worldRendererIn.func_181668_a(7, EntityLargeExplodeFX.field_181549_az);
            worldRendererIn.func_181662_b(f6 - p_180434_4_ * f5 - p_180434_7_ * f5, f7 - p_180434_5_ * f5, f8 - p_180434_6_ * f5 - p_180434_8_ * f5).func_181673_a(f2, f4).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(0, 240).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
            worldRendererIn.func_181662_b(f6 - p_180434_4_ * f5 + p_180434_7_ * f5, f7 + p_180434_5_ * f5, f8 - p_180434_6_ * f5 + p_180434_8_ * f5).func_181673_a(f2, f3).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(0, 240).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
            worldRendererIn.func_181662_b(f6 + p_180434_4_ * f5 + p_180434_7_ * f5, f7 + p_180434_5_ * f5, f8 + p_180434_6_ * f5 + p_180434_8_ * f5).func_181673_a(f, f3).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(0, 240).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
            worldRendererIn.func_181662_b(f6 + p_180434_4_ * f5 - p_180434_7_ * f5, f7 - p_180434_5_ * f5, f8 + p_180434_6_ * f5 - p_180434_8_ * f5).func_181673_a(f, f4).func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(0, 240).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
