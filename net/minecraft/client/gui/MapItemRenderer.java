...
public class MapItemRenderer
{
    ...
    class Instance
    {
        ...
        private void render(final boolean noOverlayRendering) {
            ...
            worldrenderer.func_181662_b(i + 0 + f, j + 128 - f, -0.009999999776482582).func_181673_a(0.0, 1.0).func_181675_d();
            worldrenderer.func_181662_b(i + 128 - f, j + 128 - f, -0.009999999776482582).func_181673_a(1.0, 1.0).func_181675_d();
            worldrenderer.func_181662_b(i + 128 - f, j + 0 + f, -0.009999999776482582).func_181673_a(1.0, 0.0).func_181675_d();
            worldrenderer.func_181662_b(i + 0 + f, j + 0 + f, -0.009999999776482582).func_181673_a(0.0, 0.0).func_181675_d();
            tessellator.draw();
            GlStateManager.enableAlpha();
            GlStateManager.disableBlend();
            MapItemRenderer.this.textureManager.bindTexture(MapItemRenderer.mapIcons);
            int k = 0;
            for (final Vec4b vec4b : this.mapData.playersVisibleOnMap.values()) {
                if (!noOverlayRendering || vec4b.func_176110_a() == 1) {
                    ...
                    worldrenderer.func_181662_b(-1.0, 1.0, k * -0.001f).func_181673_a(f2, f3).func_181675_d();
                    worldrenderer.func_181662_b(1.0, 1.0, k * -0.001f).func_181673_a(f4, f3).func_181675_d();
                    worldrenderer.func_181662_b(1.0, -1.0, k * -0.001f).func_181673_a(f4, f5).func_181675_d();
                    worldrenderer.func_181662_b(-1.0, -1.0, k * -0.001f).func_181673_a(f2, f5).func_181675_d();
                    tessellator.draw();
