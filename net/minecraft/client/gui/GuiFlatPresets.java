...
public class GuiFlatPresets extends GuiScreen
{
    ...
    class ListSlot extends GuiSlot
    {
        ...
        private void func_148171_c(final int p_148171_1_, final int p_148171_2_, final int p_148171_3_, final int p_148171_4_) {
            ...
            worldrenderer.func_181662_b(p_148171_1_ + 0, p_148171_2_ + 18, GuiFlatPresets.this.zLevel).func_181673_a((p_148171_3_ + 0) * 0.0078125f, (p_148171_4_ + 18) * 0.0078125f).func_181675_d();
            worldrenderer.func_181662_b(p_148171_1_ + 18, p_148171_2_ + 18, GuiFlatPresets.this.zLevel).func_181673_a((p_148171_3_ + 18) * 0.0078125f, (p_148171_4_ + 18) * 0.0078125f).func_181675_d();
            worldrenderer.func_181662_b(p_148171_1_ + 18, p_148171_2_ + 0, GuiFlatPresets.this.zLevel).func_181673_a((p_148171_3_ + 18) * 0.0078125f, (p_148171_4_ + 0) * 0.0078125f).func_181675_d();
            worldrenderer.func_181662_b(p_148171_1_ + 0, p_148171_2_ + 0, GuiFlatPresets.this.zLevel).func_181673_a((p_148171_3_ + 0) * 0.0078125f, (p_148171_4_ + 0) * 0.0078125f).func_181675_d();
            tessellator.draw();
        }
