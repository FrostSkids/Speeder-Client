...
public class GuiWinGame extends GuiScreen
{
    ...
    private void drawWinGameScreen(final int p_146575_1_, final int p_146575_2_, final float p_146575_3_) {
        ...
        f4 *= f4;
        f4 = f4 * 96.0f / 255.0f;
        worldrenderer.func_181662_b(0.0, this.height, this.zLevel).func_181673_a(0.0, f * f3).func_181666_a(f4, f4, f4, 1.0f).func_181675_d();
        worldrenderer.func_181662_b(i, this.height, this.zLevel).func_181673_a(i * f3, f * f3).func_181666_a(f4, f4, f4, 1.0f).func_181675_d();
        worldrenderer.func_181662_b(i, 0.0, this.zLevel).func_181673_a(i * f3, f2 * f3).func_181666_a(f4, f4, f4, 1.0f).func_181675_d();
        worldrenderer.func_181662_b(0.0, 0.0, this.zLevel).func_181673_a(0.0, f2 * f3).func_181666_a(f4, f4, f4, 1.0f).func_181675_d();
        tessellator.draw();
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.func_181662_b(0.0, k2, this.zLevel).func_181673_a(0.0, 1.0).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).func_181675_d();
        worldrenderer.func_181662_b(j2, k2, this.zLevel).func_181673_a(1.0, 1.0).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).func_181675_d();
        worldrenderer.func_181662_b(j2, 0.0, this.zLevel).func_181673_a(1.0, 0.0).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).func_181675_d();
