...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.field_175339_B != 0) {
            ...
            worldrenderer.func_181662_b(this.width / 2 - 90, 185.0, 0.0).func_181673_a(0.0, 2.65625).func_181669_b(64, 64, 64, 64).func_181675_d();
            worldrenderer.func_181662_b(this.width / 2 + 90, 185.0, 0.0).func_181673_a(5.625, 2.65625).func_181669_b(64, 64, 64, 64).func_181675_d();
            worldrenderer.func_181662_b(this.width / 2 + 90, 100.0, 0.0).func_181673_a(5.625, 0.0).func_181669_b(64, 64, 64, 64).func_181675_d();
            worldrenderer.func_181662_b(this.width / 2 - 90, 100.0, 0.0).func_181673_a(0.0, 0.0).func_181669_b(64, 64, 64, 64).func_181675_d();
            tessellator.draw();
