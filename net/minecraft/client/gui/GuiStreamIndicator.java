...
public class GuiStreamIndicator
{
    ...
    public void render(final int p_152437_1_, final int p_152437_2_) {
        if (this.mc.getTwitchStream().isBroadcasting()) {
            ...
            if (i > 0) {
                ...
                worldrenderer.func_181662_b(l, j2, 0.0).func_181675_d();
                worldrenderer.func_181662_b(p_152437_1_, j2, 0.0).func_181675_d();
                worldrenderer.func_181662_b(p_152437_1_, i2, 0.0).func_181675_d();
                worldrenderer.func_181662_b(l, i2, 0.0).func_181675_d();
                tessellator.draw();
    ...
    private void render(final int p_152436_1_, final int p_152436_2_, final int p_152436_3_, final int p_152436_4_) {
        ...
        worldrenderer.func_181662_b(p_152436_1_ - 16 - p_152436_4_, p_152436_2_ + 16, f).func_181673_a(f2, f5).func_181675_d();
        worldrenderer.func_181662_b(p_152436_1_ - p_152436_4_, p_152436_2_ + 16, f).func_181673_a(f4, f5).func_181675_d();
        worldrenderer.func_181662_b(p_152436_1_ - p_152436_4_, p_152436_2_ + 0, f).func_181673_a(f4, f3).func_181675_d();
        worldrenderer.func_181662_b(p_152436_1_ - 16 - p_152436_4_, p_152436_2_ + 0, f).func_181673_a(f2, f3).func_181675_d();
        tessellator.draw();
