...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    class Details extends GuiSlot
    {
        ...
        private void func_148224_c(final int p_148224_1_, final int p_148224_2_, final int p_148224_3_, final int p_148224_4_) {
            ...
            worldrenderer.func_181662_b(p_148224_1_ + 0, p_148224_2_ + 18, GuiCreateFlatWorld.this.zLevel).func_181673_a((p_148224_3_ + 0) * 0.0078125f, (p_148224_4_ + 18) * 0.0078125f).func_181675_d();
            worldrenderer.func_181662_b(p_148224_1_ + 18, p_148224_2_ + 18, GuiCreateFlatWorld.this.zLevel).func_181673_a((p_148224_3_ + 18) * 0.0078125f, (p_148224_4_ + 18) * 0.0078125f).func_181675_d();
            worldrenderer.func_181662_b(p_148224_1_ + 18, p_148224_2_ + 0, GuiCreateFlatWorld.this.zLevel).func_181673_a((p_148224_3_ + 18) * 0.0078125f, (p_148224_4_ + 0) * 0.0078125f).func_181675_d();
            worldrenderer.func_181662_b(p_148224_1_ + 0, p_148224_2_ + 0, GuiCreateFlatWorld.this.zLevel).func_181673_a((p_148224_3_ + 0) * 0.0078125f, (p_148224_4_ + 0) * 0.0078125f).func_181675_d();
            tessellator.draw();
        }
