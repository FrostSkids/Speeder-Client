...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    class ListPreset extends GuiSlot
    {
        ...
        private void func_178051_a(final int p_178051_1_, final int p_178051_2_, final ResourceLocation p_178051_3_) {
            ...
            worldrenderer.func_181662_b(i + 0, p_178051_2_ + 32, 0.0).func_181673_a(0.0, 1.0).func_181675_d();
            worldrenderer.func_181662_b(i + 32, p_178051_2_ + 32, 0.0).func_181673_a(1.0, 1.0).func_181675_d();
            worldrenderer.func_181662_b(i + 32, p_178051_2_ + 0, 0.0).func_181673_a(1.0, 0.0).func_181675_d();
            worldrenderer.func_181662_b(i + 0, p_178051_2_ + 0, 0.0).func_181673_a(0.0, 0.0).func_181675_d();
            tessellator.draw();
        }
