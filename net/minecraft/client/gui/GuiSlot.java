...
public abstract class GuiSlot
{
    ...
    public void drawScreen(final int mouseXIn, final int mouseYIn, final float p_148128_3_) {
        if (this.field_178041_q) {
            ...
            worldrenderer.func_181662_b(this.left, this.top + i2, 0.0).func_181673_a(0.0, 1.0).func_181669_b(0, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b(this.right, this.top + i2, 0.0).func_181673_a(1.0, 1.0).func_181669_b(0, 0, 0, 0).func_181675_d();
            ...
            worldrenderer.func_181662_b(this.right, this.bottom - i2, 0.0).func_181673_a(1.0, 0.0).func_181669_b(0, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b(this.left, this.bottom - i2, 0.0).func_181673_a(0.0, 0.0).func_181669_b(0, 0, 0, 0).func_181675_d();
            tessellator.draw();
            ...
            if (j2 > 0) {
                ...
                tessellator.draw();
                worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
                worldrenderer.func_181662_b(i, l2 + k2, 0.0).func_181673_a(0.0, 1.0).func_181669_b(128, 128, 128, 255).func_181675_d();
                worldrenderer.func_181662_b(j, l2 + k2, 0.0).func_181673_a(1.0, 1.0).func_181669_b(128, 128, 128, 255).func_181675_d();
                worldrenderer.func_181662_b(j, l2, 0.0).func_181673_a(1.0, 0.0).func_181669_b(128, 128, 128, 255).func_181675_d();
                worldrenderer.func_181662_b(i, l2, 0.0).func_181673_a(0.0, 0.0).func_181669_b(128, 128, 128, 255).func_181675_d();
                tessellator.draw();
                worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
                worldrenderer.func_181662_b(i, l2 + k2 - 1, 0.0).func_181673_a(0.0, 1.0).func_181669_b(192, 192, 192, 255).func_181675_d();
                worldrenderer.func_181662_b(j - 1, l2 + k2 - 1, 0.0).func_181673_a(1.0, 1.0).func_181669_b(192, 192, 192, 255).func_181675_d();
                worldrenderer.func_181662_b(j - 1, l2, 0.0).func_181673_a(1.0, 0.0).func_181669_b(192, 192, 192, 255).func_181675_d();
                worldrenderer.func_181662_b(i, l2, 0.0).func_181673_a(0.0, 0.0).func_181669_b(192, 192, 192, 255).func_181675_d();
                tessellator.draw();
            }
    ...
    protected void drawSelectionBox(final int p_148120_1_, final int p_148120_2_, final int mouseXIn, final int mouseYIn) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            if (this.showSelectionBox && this.isSelected(j)) {
                ...
                GlStateManager.disableTexture2D();
                worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
                worldrenderer.func_181662_b(i2, k + l + 2, 0.0).func_181673_a(0.0, 1.0).func_181669_b(128, 128, 128, 255).func_181675_d();
                worldrenderer.func_181662_b(j2, k + l + 2, 0.0).func_181673_a(1.0, 1.0).func_181669_b(128, 128, 128, 255).func_181675_d();
                worldrenderer.func_181662_b(j2, k - 2, 0.0).func_181673_a(1.0, 0.0).func_181669_b(128, 128, 128, 255).func_181675_d();
                worldrenderer.func_181662_b(i2, k - 2, 0.0).func_181673_a(0.0, 0.0).func_181669_b(128, 128, 128, 255).func_181675_d();
                worldrenderer.func_181662_b(i2 + 1, k + l + 1, 0.0).func_181673_a(0.0, 1.0).func_181669_b(0, 0, 0, 255).func_181675_d();
                worldrenderer.func_181662_b(j2 - 1, k + l + 1, 0.0).func_181673_a(1.0, 1.0).func_181669_b(0, 0, 0, 255).func_181675_d();
                worldrenderer.func_181662_b(j2 - 1, k - 1, 0.0).func_181673_a(1.0, 0.0).func_181669_b(0, 0, 0, 255).func_181675_d();
                worldrenderer.func_181662_b(i2 + 1, k - 1, 0.0).func_181673_a(0.0, 0.0).func_181669_b(0, 0, 0, 255).func_181675_d();
                tessellator.draw();
                GlStateManager.enableTexture2D();
            }
    ...
    protected void overlayBackground(final int startY, final int endY, final int startAlpha, final int endAlpha) {
        ...
        final float f = 32.0f;
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.func_181662_b(this.left, endY, 0.0).func_181673_a(0.0, endY / 32.0f).func_181669_b(64, 64, 64, endAlpha).func_181675_d();
        worldrenderer.func_181662_b(this.left + this.width, endY, 0.0).func_181673_a(this.width / 32.0f, endY / 32.0f).func_181669_b(64, 64, 64, endAlpha).func_181675_d();
        worldrenderer.func_181662_b(this.left + this.width, startY, 0.0).func_181673_a(this.width / 32.0f, startY / 32.0f).func_181669_b(64, 64, 64, startAlpha).func_181675_d();
        worldrenderer.func_181662_b(this.left, startY, 0.0).func_181673_a(0.0, startY / 32.0f).func_181669_b(64, 64, 64, startAlpha).func_181675_d();
        tessellator.draw();
    }
    ...
    protected void drawContainerBackground(final Tessellator p_drawContainerBackground_1_) {
        ...
        final float f = 32.0f;
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.func_181662_b(this.left, this.bottom, 0.0).func_181673_a(this.left / f, (this.bottom + (int)this.amountScrolled) / f).func_181669_b(32, 32, 32, 255).func_181675_d();
        worldrenderer.func_181662_b(this.right, this.bottom, 0.0).func_181673_a(this.right / f, (this.bottom + (int)this.amountScrolled) / f).func_181669_b(32, 32, 32, 255).func_181675_d();
        worldrenderer.func_181662_b(this.right, this.top, 0.0).func_181673_a(this.right / f, (this.top + (int)this.amountScrolled) / f).func_181669_b(32, 32, 32, 255).func_181675_d();
        worldrenderer.func_181662_b(this.left, this.top, 0.0).func_181673_a(this.left / f, (this.top + (int)this.amountScrolled) / f).func_181669_b(32, 32, 32, 255).func_181675_d();
