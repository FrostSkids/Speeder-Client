...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onLivingUpdate() {
        ...
        else if (!this.isPotionActive(Potion.blindness)) {
        ...
        if (!this.isSprinting() && this.movementInput.moveForward >= f && flag4 && !this.isPotionActive(Potion.blindness) && !this.isUsingItem()) {
            this.setSprinting(true);
        }
