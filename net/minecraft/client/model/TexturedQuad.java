...
public class TexturedQuad
{
    ...
    public void draw(final WorldRenderer renderer, final float scale) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            renderer.func_181662_b(positiontexturevertex.vector3D.xCoord * scale, positiontexturevertex.vector3D.yCoord * scale, positiontexturevertex.vector3D.zCoord * scale).func_181673_a(positiontexturevertex.texturePositionX, positiontexturevertex.texturePositionY).func_181663_c(f, f2, f3).func_181675_d();
        }
