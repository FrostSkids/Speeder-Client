    ...
    private void orientCamera(final float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
            ...
            if (!this.mc.gameSettings.debugCamEnable) {
                ...
                GlStateManager.rotate(ModInstances.getModPerspective().getCameraYaw() + (entity.rotationYaw - entity.prevRotationYaw) * partialTicks + 180.0f, 0.0f, -1.0f, 0.0f);
                    ...
                    if (biomegenbase.canSpawnLightningBolt() || biomegenbase.getEnableSnow()) {
                        ...
                        if (k3 != l3) {
                            ...
                            if (world.getWorldChunkManager().getTemperatureAtHeight(f7, j3) >= 0.15f) {
                                ...
                                worldrenderer.func_181662_b(l2 - d4 + 0.5, k3, k2 - d5 + 0.5).func_181673_a(0.0, k3 * 0.25 + d6).func_181666_a(1.0f, 1.0f, 1.0f, f9).func_181671_a(k4, l4).func_181675_d();
                                worldrenderer.func_181662_b(l2 + d4 + 0.5, k3, k2 + d5 + 0.5).func_181673_a(1.0, k3 * 0.25 + d6).func_181666_a(1.0f, 1.0f, 1.0f, f9).func_181671_a(k4, l4).func_181675_d();
                                worldrenderer.func_181662_b(l2 + d4 + 0.5, l3, k2 + d5 + 0.5).func_181673_a(1.0, l3 * 0.25 + d6).func_181666_a(1.0f, 1.0f, 1.0f, f9).func_181671_a(k4, l4).func_181675_d();
                                worldrenderer.func_181662_b(l2 - d4 + 0.5, l3, k2 - d5 + 0.5).func_181673_a(0.0, l3 * 0.25 + d6).func_181666_a(1.0f, 1.0f, 1.0f, f9).func_181671_a(k4, l4).func_181675_d();
                            }
                            else {
                                if (j2 != 1) {
                                    if (j2 >= 0) {
                                ...
                                worldrenderer.func_181662_b(l2 - d4 + 0.5, k3, k2 - d5 + 0.5).func_181673_a(0.0 + d10, k3 * 0.25 + d9 + d11).func_181666_a(1.0f, 1.0f, 1.0f, f11).func_181671_a(j5, k5).func_181675_d();
                                worldrenderer.func_181662_b(l2 + d4 + 0.5, k3, k2 + d5 + 0.5).func_181673_a(1.0 + d10, k3 * 0.25 + d9 + d11).func_181666_a(1.0f, 1.0f, 1.0f, f11).func_181671_a(j5, k5).func_181675_d();
                                worldrenderer.func_181662_b(l2 + d4 + 0.5, l3, k2 + d5 + 0.5).func_181673_a(1.0 + d10, l3 * 0.25 + d9 + d11).func_181666_a(1.0f, 1.0f, 1.0f, f11).func_181671_a(j5, k5).func_181675_d();
                                worldrenderer.func_181662_b(l2 - d4 + 0.5, l3, k2 - d5 + 0.5).func_181673_a(0.0 + d10, l3 * 0.25 + d9 + d11).func_181666_a(1.0f, 1.0f, 1.0f, f11).func_181671_a(j5, k5).func_181675_d();
                            }
                        }
                    }
                }
