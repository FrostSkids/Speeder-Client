...
public class FaceBakery
{
    ...
    private void storeVertexData(final int[] faceData, final int storeIndex, final int vertexIndex, final Vector3f position, final int shadeColor, final TextureAtlasSprite sprite, final BlockFaceUV faceUV) {
        ...
        faceData[j + 4] = Float.floatToRawIntBits(sprite.getInterpolatedU(faceUV.func_178348_a(vertexIndex) * 0.999 + faceUV.func_178348_a((vertexIndex + 2) % 4) * 0.001));
        faceData[j + 4 + 1] = Float.floatToRawIntBits(sprite.getInterpolatedV(faceUV.func_178346_b(vertexIndex) * 0.999 + faceUV.func_178346_b((vertexIndex + 2) % 4) * 0.001));
    }
    ...
    private void func_178407_a(final Vector3f p_178407_1_, final BlockPartRotation partRotation) {
        if (partRotation != null) {
            ...
            switch (partRotation.axis) {
                case X: {
                    Matrix4f.rotate(partRotation.angle * 0.017453292f, new Vector3f(1.0f, 0.0f, 0.0f), (org.lwjgl.util.vector.Matrix4f)matrix4f, (org.lwjgl.util.vector.Matrix4f)matrix4f);
                    vector3f.set(0.0f, 1.0f, 1.0f);
                    break;
                }
                case Y: {
                    Matrix4f.rotate(partRotation.angle * 0.017453292f, new Vector3f(0.0f, 1.0f, 0.0f), (org.lwjgl.util.vector.Matrix4f)matrix4f, (org.lwjgl.util.vector.Matrix4f)matrix4f);
                    vector3f.set(1.0f, 0.0f, 1.0f);
                    break;
                }
                case Z: {
                    Matrix4f.rotate(partRotation.angle * 0.017453292f, new Vector3f(0.0f, 0.0f, 1.0f), (org.lwjgl.util.vector.Matrix4f)matrix4f, (org.lwjgl.util.vector.Matrix4f)matrix4f);
    ...
    private void rotateScale(final Vector3f position, final Vector3f rotationOrigin, final org.lwjgl.util.vector.Matrix4f matrix4f, final Vector3f scale) {
