...
public class OpenGlHelper
{
    ...
    public static void initializeTextures() {
        ...
        if (!(OpenGlHelper.vboRegions = (flag && flag2))) {
            ...
            Config.dbg(s);
            OpenGlHelper.logText = String.valueOf(OpenGlHelper.logText) + s + "\n";
        }
        ...
        final String s2 = GL11.glGetString(7936).toLowerCase();
        ...
        OpenGlHelper.field_181063_b = s2.contains("ati");
