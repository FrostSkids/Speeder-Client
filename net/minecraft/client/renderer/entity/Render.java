...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    private void renderEntityOnFire(final Entity entity, final double x, final double y, final double z, final float partialTicks) {
        ...
        while (f4 > 0.0f) {
            ...
            worldrenderer.func_181662_b(f2 - f3, 0.0f - f5, f6).func_181673_a(f9, f10).func_181675_d();
            worldrenderer.func_181662_b(-f2 - f3, 0.0f - f5, f6).func_181673_a(f7, f10).func_181675_d();
            worldrenderer.func_181662_b(-f2 - f3, 1.4f - f5, f6).func_181673_a(f7, f8).func_181675_d();
            worldrenderer.func_181662_b(f2 - f3, 1.4f - f5, f6).func_181673_a(f9, f8).func_181675_d();
            f4 -= 0.45f;
            f5 -= 0.45f;
            f2 *= 0.9f;
            f6 += 0.03f;
    ...
    private void func_180549_a(final Block blockIn, final double p_180549_2_, final double p_180549_4_, final double p_180549_6_, final BlockPos pos, final float p_180549_9_, final float p_180549_10_, final double p_180549_11_, final double p_180549_13_, final double p_180549_15_) {
        if (blockIn.isFullCube()) {
            ...
            if (d0 >= 0.0) {
                ...
                worldrenderer.func_181662_b(d2, d4, d5).func_181673_a(f, f3).func_181666_a(1.0f, 1.0f, 1.0f, (float)d0).func_181675_d();
                worldrenderer.func_181662_b(d2, d4, d6).func_181673_a(f, f4).func_181666_a(1.0f, 1.0f, 1.0f, (float)d0).func_181675_d();
                worldrenderer.func_181662_b(d3, d4, d6).func_181673_a(f2, f4).func_181666_a(1.0f, 1.0f, 1.0f, (float)d0).func_181675_d();
                worldrenderer.func_181662_b(d3, d4, d5).func_181673_a(f2, f3).func_181666_a(1.0f, 1.0f, 1.0f, (float)d0).func_181675_d();
            }
        }
    }
