...
public class RenderDragon extends RenderLiving<EntityDragon>
{
    ...
    protected void drawRechargeRay(final EntityDragon dragon, final double p_180574_2_, final double p_180574_4_, final double p_180574_6_, final float p_180574_8_) {
        ...
        for (int j = 0; j <= 8; ++j) {
            ...
            worldrenderer.func_181662_b(f10 * 0.2f, f11 * 0.2f, 0.0).func_181673_a(f12, f9).func_181669_b(0, 0, 0, 255).func_181675_d();
            worldrenderer.func_181662_b(f10, f11, f7).func_181673_a(f12, f8).func_181669_b(255, 255, 255, 255).func_181675_d();
        }
        tessellator.draw();
