    ...
    public void doRenderLayer(final EntityDragon entitylivingbaseIn, final float p_177141_2_, final float p_177141_3_, final float partialTicks, final float p_177141_5_, final float p_177141_6_, final float p_177141_7_, final float scale) {
        if (entitylivingbaseIn.deathTicks > 0) {
            ...
            for (int i = 0; i < (f + f * f) / 2.0f * 60.0f; ++i) {
                ...
                worldrenderer.func_181662_b(0.0, 0.0, 0.0).func_181669_b(255, 255, 255, (int)(255.0f * (1.0f - f2))).func_181675_d();
                worldrenderer.func_181662_b(-0.866 * f4, f3, -0.5f * f4).func_181669_b(255, 0, 255, 0).func_181675_d();
                worldrenderer.func_181662_b(0.866 * f4, f3, -0.5f * f4).func_181669_b(255, 0, 255, 0).func_181675_d();
                worldrenderer.func_181662_b(0.0, f3, 1.0f * f4).func_181669_b(255, 0, 255, 0).func_181675_d();
                worldrenderer.func_181662_b(-0.866 * f4, f3, -0.5f * f4).func_181669_b(255, 0, 255, 0).func_181675_d();
                tessellator.draw();
            }
