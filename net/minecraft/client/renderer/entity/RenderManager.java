...
public class RenderManager
{
    ...
    private void renderDebugBoundingBox(final Entity entityIn, final double p_85094_2_, final double p_85094_4_, final double p_85094_6_, final float p_85094_8_, final float p_85094_9_) {
        ...
        worldrenderer.func_181662_b(p_85094_2_, p_85094_4_ + entityIn.getEyeHeight(), p_85094_6_).func_181669_b(0, 0, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(p_85094_2_ + vec3.xCoord * 2.0, p_85094_4_ + entityIn.getEyeHeight() + vec3.yCoord * 2.0, p_85094_6_ + vec3.zCoord * 2.0).func_181669_b(0, 0, 255, 255).func_181675_d();
        tessellator.draw();
