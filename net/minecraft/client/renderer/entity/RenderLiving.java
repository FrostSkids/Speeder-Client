        ...
        if (!Config.isShaders() || !Shaders.isShadowPass) {
            ...
            if (entity != null) {
                ...
                for (int j = 0; j <= 24; ++j) {
                    ...
                    worldrenderer.func_181662_b(x + d14 * f4 + 0.0, y + d15 * (f4 * f4 + f4) * 0.5 + ((24.0f - j) / 18.0f + 0.125f), z + d16 * f4).func_181666_a(f, f2, f3, 1.0f).func_181675_d();
                    worldrenderer.func_181662_b(x + d14 * f4 + 0.025, y + d15 * (f4 * f4 + f4) * 0.5 + ((24.0f - j) / 18.0f + 0.125f) + 0.025, z + d16 * f4).func_181666_a(f, f2, f3, 1.0f).func_181675_d();
                }
                tessellator.draw();
                worldrenderer.func_181668_a(5, DefaultVertexFormats.field_181706_f);
                for (int k = 0; k <= 24; ++k) {
                    ...
                    worldrenderer.func_181662_b(x + d14 * f8 + 0.0, y + d15 * (f8 * f8 + f8) * 0.5 + ((24.0f - k) / 18.0f + 0.125f) + 0.025, z + d16 * f8).func_181666_a(f5, f6, f7, 1.0f).func_181675_d();
                    worldrenderer.func_181662_b(x + d14 * f8 + 0.025, y + d15 * (f8 * f8 + f8) * 0.5 + ((24.0f - k) / 18.0f + 0.125f), z + d16 * f8 + 0.025).func_181666_a(f5, f6, f7, 1.0f).func_181675_d();
                }
                tessellator.draw();
                if (Config.isShaders()) {
                    Shaders.endLeash();
