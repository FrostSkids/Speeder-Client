            ...
            for (int j = 0; j < 3; ++j) {
                ...
                for (int i2 = l; i2 >= m; --i2) {
                    ...
                    for (int j2 = 0; j2 < 5; ++j2) {
                        ...
                        worldrenderer.func_181662_b(d11 + d3, y + i2 * 16, d12 + d4).func_181666_a(0.45f, 0.45f, 0.5f, 0.3f).func_181675_d();
                        worldrenderer.func_181662_b(d9 + d5, y + (i2 + 1) * 16, d10 + d6).func_181666_a(0.45f, 0.45f, 0.5f, 0.3f).func_181675_d();
                    }
                    tessellator.draw();
                }
            }
