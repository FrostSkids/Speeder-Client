...
public class RenderFireball extends Render<EntityFireball>
{
    ...
    public void doRender(final EntityFireball entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        worldrenderer.func_181662_b(-0.5, -0.25, 0.0).func_181673_a(f, f4).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
        worldrenderer.func_181662_b(0.5, -0.25, 0.0).func_181673_a(f2, f4).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
        worldrenderer.func_181662_b(0.5, 0.75, 0.0).func_181673_a(f2, f3).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
        worldrenderer.func_181662_b(-0.5, 0.75, 0.0).func_181673_a(f, f3).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
        tessellator.draw();
