...
public class RenderGuardian extends RenderLiving<EntityGuardian>
{
    ...
    public void doRender(final EntityGuardian entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        if (entitylivingbase != null) {
            ...
            worldrenderer.func_181662_b(d13, d0, d14).func_181673_a(0.4999, d24).func_181669_b(j, k, l, 255).func_181675_d();
            worldrenderer.func_181662_b(d13, 0.0, d14).func_181673_a(0.4999, d23).func_181669_b(j, k, l, 255).func_181675_d();
            worldrenderer.func_181662_b(d15, 0.0, d16).func_181673_a(0.0, d23).func_181669_b(j, k, l, 255).func_181675_d();
            worldrenderer.func_181662_b(d15, d0, d16).func_181673_a(0.0, d24).func_181669_b(j, k, l, 255).func_181675_d();
            worldrenderer.func_181662_b(d17, d0, d18).func_181673_a(0.4999, d24).func_181669_b(j, k, l, 255).func_181675_d();
            worldrenderer.func_181662_b(d17, 0.0, d18).func_181673_a(0.4999, d23).func_181669_b(j, k, l, 255).func_181675_d();
            worldrenderer.func_181662_b(d19, 0.0, d20).func_181673_a(0.0, d23).func_181669_b(j, k, l, 255).func_181675_d();
            worldrenderer.func_181662_b(d19, d0, d20).func_181673_a(0.0, d24).func_181669_b(j, k, l, 255).func_181675_d();
            double d25 = 0.0;
            if (entity.ticksExisted % 2 == 0) {
                d25 = 0.5;
            }
            worldrenderer.func_181662_b(d5, d0, d6).func_181673_a(0.5, d25 + 0.5).func_181669_b(j, k, l, 255).func_181675_d();
            worldrenderer.func_181662_b(d7, d0, d8).func_181673_a(1.0, d25 + 0.5).func_181669_b(j, k, l, 255).func_181675_d();
            worldrenderer.func_181662_b(d11, d0, d12).func_181673_a(1.0, d25).func_181669_b(j, k, l, 255).func_181675_d();
            worldrenderer.func_181662_b(d9, d0, d10).func_181673_a(0.5, d25).func_181669_b(j, k, l, 255).func_181675_d();
            tessellator.draw();
