    ...
    public void renderTileEntityAt(final TileEntityEndPortal te, final double x, final double y, final double z, final float partialTicks, final int destroyStage) {
        if (!Config.isShaders() || !ShadersRender.renderEndPortal(te, x, y, z, partialTicks, destroyStage, 0.75f)) {
            ...
            for (int i = 0; i < 16; ++i) {
                ...
                worldrenderer.func_181662_b(x, y + f4, z).func_181666_a(f12, f13, f14, 1.0f).func_181675_d();
                worldrenderer.func_181662_b(x, y + f4, z + 1.0).func_181666_a(f12, f13, f14, 1.0f).func_181675_d();
                worldrenderer.func_181662_b(x + 1.0, y + f4, z + 1.0).func_181666_a(f12, f13, f14, 1.0f).func_181675_d();
                worldrenderer.func_181662_b(x + 1.0, y + f4, z).func_181666_a(f12, f13, f14, 1.0f).func_181675_d();
                tessellator.draw();
                GlStateManager.popMatrix();
