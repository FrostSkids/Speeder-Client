...
public class ItemRenderer
{
    ...
    private void func_178108_a(final float p_178108_1_, final TextureAtlasSprite p_178108_2_) {
        ...
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
        worldrenderer.func_181662_b(-1.0, -1.0, -0.5).func_181673_a(f8, f10).func_181675_d();
        worldrenderer.func_181662_b(1.0, -1.0, -0.5).func_181673_a(f7, f10).func_181675_d();
        worldrenderer.func_181662_b(1.0, 1.0, -0.5).func_181673_a(f7, f9).func_181675_d();
        worldrenderer.func_181662_b(-1.0, 1.0, -0.5).func_181673_a(f8, f9).func_181675_d();
        tessellator.draw();
        GlStateManager.popMatrix();
    ...
    private void renderWaterOverlayTexture(final float p_78448_1_) {
        if (!Config.isShaders() || Shaders.isUnderwaterOverlay()) {
            ...
            worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
            worldrenderer.func_181662_b(-1.0, -1.0, -0.5).func_181673_a(4.0f + f8, 4.0f + f9).func_181675_d();
            worldrenderer.func_181662_b(1.0, -1.0, -0.5).func_181673_a(0.0f + f8, 4.0f + f9).func_181675_d();
            worldrenderer.func_181662_b(1.0, 1.0, -0.5).func_181673_a(0.0f + f8, 0.0f + f9).func_181675_d();
            worldrenderer.func_181662_b(-1.0, 1.0, -0.5).func_181673_a(4.0f + f8, 0.0f + f9).func_181675_d();
            tessellator.draw();
            GlStateManager.popMatrix();
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
    ...
    private void renderFireInFirstPerson(final float p_78442_1_) {
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            worldrenderer.func_181662_b(f6, f8, f10).func_181673_a(f3, f5).func_181675_d();
            worldrenderer.func_181662_b(f7, f8, f10).func_181673_a(f2, f5).func_181675_d();
            worldrenderer.func_181662_b(f7, f9, f10).func_181673_a(f2, f4).func_181675_d();
            worldrenderer.func_181662_b(f6, f9, f10).func_181673_a(f3, f4).func_181675_d();
            tessellator.draw();
            GlStateManager.popMatrix();
        }
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
