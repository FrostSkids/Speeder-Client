    ...
    private void renderSky(final WorldRenderer worldRendererIn, final float p_174968_2_, final boolean p_174968_3_) {
        ...
        for (int k = (this.renderDistance / 64 + 1) * 64 + 64, l = -k; l <= k; l += 64) {
            for (int i2 = -k; i2 <= k; i2 += 64) {
                ...
                worldRendererIn.func_181662_b(f, p_174968_2_, i2).func_181675_d();
                worldRendererIn.func_181662_b(f2, p_174968_2_, i2).func_181675_d();
                worldRendererIn.func_181662_b(f2, p_174968_2_, i2 + 64).func_181675_d();
                worldRendererIn.func_181662_b(f, p_174968_2_, i2 + 64).func_181675_d();
            }
        }
    }
        ...
        for (int i = 0; i < 1500; ++i) {
            ...
            if (d5 < 1.0 && d5 > 0.01) {
                ...
                for (int j = 0; j < 4; ++j) {
                    ...
                    worldRendererIn.func_181662_b(d6 + d26, d7 + d24, d8 + d27).func_181675_d();
                }
            }
        }
    }
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            if (this.isRenderEntityOutlines()) {
                ...
                for (int k = 0; k < list.size(); ++k) {
                    ...
                    final boolean flag4 = entity3.isInRangeToRender3d(d0, d2, d3) && (entity3.ignoreFrustumCheck || camera.isBoundingBoxInFrustum(entity3.getEntityBoundingBox()) || entity3.riddenByEntity == this.mc.thePlayer) && entity3 instanceof EntityPlayer;
                ...
                if (!classinheritancemultimap.isEmpty()) {
                    for (final Entity entity4 : classinheritancemultimap) {
                        if (!flag || Reflector.callBoolean(entity4, Reflector.ForgeEntity_shouldRenderInPass, i)) {
                            final boolean flag7 = this.renderManager.shouldRender(entity4, camera, d0, d2, d3) || entity4.riddenByEntity == this.mc.thePlayer;
                            if (flag7) {
                            ...
                            if (flag7 || !(entity4 instanceof EntityWitherSkull) || (flag && !Reflector.callBoolean(entity4, Reflector.ForgeEntity_shouldRenderInPass, i))) {
                                continue;
                            }
                            this.renderedEntity = entity4;
                            if (flag5) {
                ...
                if (flag2) {
                    ...
                    if (tileentity3 != null && Reflector.callBoolean(tileentity3, Reflector.ForgeTileEntity_shouldRenderInPass, i) && Reflector.callBoolean(tileentity3, Reflector.ForgeTileEntity_canRenderBreaking, new Object[0])) {
                        ...
                        if (axisalignedbb2 != null) {
                            flag9 = camera.isBoundingBoxInFrustum(axisalignedbb2);
                        }
                    }
                }
                else {
    ...
    public void renderSky(final float partialTicks, final int pass) {
        ...
        if (this.mc.theWorld.provider.getDimensionId() == 1) {
            ...
            if (afloat != null && Config.isSunMoonEnabled()) {
                ...
                worldrenderer.func_181662_b(0.0, 100.0, 0.0).func_181666_a(f7, f8, f9, afloat[3]).func_181675_d();
                final int j = 16;
                for (int l = 0; l <= 16; ++l) {
                    final float f13 = l * 3.1415927f * 2.0f / 16.0f;
                    final float f14 = MathHelper.sin(f13);
                    final float f15 = MathHelper.cos(f13);
                    worldrenderer.func_181662_b(f14 * 120.0f, f15 * 120.0f, -f15 * 40.0f * afloat[3]).func_181666_a(afloat[0], afloat[1], afloat[2], 0.0f).func_181675_d();
                }
                tessellator.draw();
                GlStateManager.popMatrix();
            ...
            if (Config.isSunTexture()) {
                ...
                worldrenderer.func_181662_b(-f17, 100.0, -f17).func_181673_a(0.0, 0.0).func_181675_d();
                worldrenderer.func_181662_b(f17, 100.0, -f17).func_181673_a(1.0, 0.0).func_181675_d();
                worldrenderer.func_181662_b(f17, 100.0, f17).func_181673_a(1.0, 1.0).func_181675_d();
                worldrenderer.func_181662_b(-f17, 100.0, f17).func_181673_a(0.0, 1.0).func_181675_d();
                tessellator.draw();
            }
            f17 = 20.0f;
            if (Config.isMoonTexture()) {
                ...
                worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
                worldrenderer.func_181662_b(-f17, -100.0, f17).func_181673_a(f20, f21).func_181675_d();
                worldrenderer.func_181662_b(f17, -100.0, f17).func_181673_a(f18, f21).func_181675_d();
                worldrenderer.func_181662_b(f17, -100.0, -f17).func_181673_a(f18, f19).func_181675_d();
                worldrenderer.func_181662_b(-f17, -100.0, -f17).func_181673_a(f20, f19).func_181675_d();
                tessellator.draw();
            }
            GlStateManager.disableTexture2D();
            if (flag) {
            ...
            if (d0 < 0.0) {
                ...
                worldrenderer.func_181662_b(-1.0, f24, 1.0).func_181669_b(0, 0, 0, 255).func_181675_d();
                worldrenderer.func_181662_b(1.0, f24, 1.0).func_181669_b(0, 0, 0, 255).func_181675_d();
                    ...
                    if (this.cloudRenderer.shouldUpdateGlList()) {
                        ...
                        for (int i2 = -256; i2 < 256; i2 += 32) {
                            for (int j2 = -256; j2 < 256; j2 += 32) {
                                worldrenderer.func_181662_b(i2 + 0, f18, j2 + 32).func_181673_a((i2 + 0) * 4.8828125E-4f + f19, (j2 + 32) * 4.8828125E-4f + f20).func_181666_a(f11, f12, f13, 0.8f).func_181675_d();
                                worldrenderer.func_181662_b(i2 + 32, f18, j2 + 32).func_181673_a((i2 + 32) * 4.8828125E-4f + f19, (j2 + 32) * 4.8828125E-4f + f20).func_181666_a(f11, f12, f13, 0.8f).func_181675_d();
                                worldrenderer.func_181662_b(i2 + 32, f18, j2 + 0).func_181673_a((i2 + 32) * 4.8828125E-4f + f19, (j2 + 0) * 4.8828125E-4f + f20).func_181666_a(f11, f12, f13, 0.8f).func_181675_d();
                                worldrenderer.func_181662_b(i2 + 0, f18, j2 + 0).func_181673_a((i2 + 0) * 4.8828125E-4f + f19, (j2 + 0) * 4.8828125E-4f + f20).func_181666_a(f11, f12, f13, 0.8f).func_181675_d();
                            }
                        }
                        tessellator.draw();
        ...
        if (this.cloudRenderer.shouldUpdateGlList()) {
            ...
            for (int l2 = -3; l2 <= 4; ++l2) {
                for (int j2 = -3; j2 <= 4; ++j2) {
                    ...
                    if (f4 > -5.0f) {
                        worldrenderer.func_181662_b(f28 + 0.0f, f4 + 0.0f, f29 + 8.0f).func_181673_a((f26 + 0.0f) * 0.00390625f + f21, (f27 + 8.0f) * 0.00390625f + f22).func_181666_a(f14, f15, f16, 0.8f).func_181663_c(0.0f, -1.0f, 0.0f).func_181675_d();
                        worldrenderer.func_181662_b(f28 + 8.0f, f4 + 0.0f, f29 + 8.0f).func_181673_a((f26 + 8.0f) * 0.00390625f + f21, (f27 + 8.0f) * 0.00390625f + f22).func_181666_a(f14, f15, f16, 0.8f).func_181663_c(0.0f, -1.0f, 0.0f).func_181675_d();
                        worldrenderer.func_181662_b(f28 + 8.0f, f4 + 0.0f, f29 + 0.0f).func_181673_a((f26 + 8.0f) * 0.00390625f + f21, (f27 + 0.0f) * 0.00390625f + f22).func_181666_a(f14, f15, f16, 0.8f).func_181663_c(0.0f, -1.0f, 0.0f).func_181675_d();
                        worldrenderer.func_181662_b(f28 + 0.0f, f4 + 0.0f, f29 + 0.0f).func_181673_a((f26 + 0.0f) * 0.00390625f + f21, (f27 + 0.0f) * 0.00390625f + f22).func_181666_a(f14, f15, f16, 0.8f).func_181663_c(0.0f, -1.0f, 0.0f).func_181675_d();
                    }
                    if (f4 <= 5.0f) {
                        worldrenderer.func_181662_b(f28 + 0.0f, f4 + 4.0f - 9.765625E-4f, f29 + 8.0f).func_181673_a((f26 + 0.0f) * 0.00390625f + f21, (f27 + 8.0f) * 0.00390625f + f22).func_181666_a(f5, f6, f7, 0.8f).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
                        worldrenderer.func_181662_b(f28 + 8.0f, f4 + 4.0f - 9.765625E-4f, f29 + 8.0f).func_181673_a((f26 + 8.0f) * 0.00390625f + f21, (f27 + 8.0f) * 0.00390625f + f22).func_181666_a(f5, f6, f7, 0.8f).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
                        worldrenderer.func_181662_b(f28 + 8.0f, f4 + 4.0f - 9.765625E-4f, f29 + 0.0f).func_181673_a((f26 + 8.0f) * 0.00390625f + f21, (f27 + 0.0f) * 0.00390625f + f22).func_181666_a(f5, f6, f7, 0.8f).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
                        worldrenderer.func_181662_b(f28 + 0.0f, f4 + 4.0f - 9.765625E-4f, f29 + 0.0f).func_181673_a((f26 + 0.0f) * 0.00390625f + f21, (f27 + 0.0f) * 0.00390625f + f22).func_181666_a(f5, f6, f7, 0.8f).func_181663_c(0.0f, 1.0f, 0.0f).func_181675_d();
                    }
                    if (l2 > -1) {
                        for (int k2 = 0; k2 < 8; ++k2) {
                            worldrenderer.func_181662_b(f28 + k2 + 0.0f, f4 + 0.0f, f29 + 8.0f).func_181673_a((f26 + k2 + 0.5f) * 0.00390625f + f21, (f27 + 8.0f) * 0.00390625f + f22).func_181666_a(f11, f12, f13, 0.8f).func_181663_c(-1.0f, 0.0f, 0.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + k2 + 0.0f, f4 + 4.0f, f29 + 8.0f).func_181673_a((f26 + k2 + 0.5f) * 0.00390625f + f21, (f27 + 8.0f) * 0.00390625f + f22).func_181666_a(f11, f12, f13, 0.8f).func_181663_c(-1.0f, 0.0f, 0.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + k2 + 0.0f, f4 + 4.0f, f29 + 0.0f).func_181673_a((f26 + k2 + 0.5f) * 0.00390625f + f21, (f27 + 0.0f) * 0.00390625f + f22).func_181666_a(f11, f12, f13, 0.8f).func_181663_c(-1.0f, 0.0f, 0.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + k2 + 0.0f, f4 + 0.0f, f29 + 0.0f).func_181673_a((f26 + k2 + 0.5f) * 0.00390625f + f21, (f27 + 0.0f) * 0.00390625f + f22).func_181666_a(f11, f12, f13, 0.8f).func_181663_c(-1.0f, 0.0f, 0.0f).func_181675_d();
                        }
                    }
                    if (l2 <= 1) {
                        for (int i3 = 0; i3 < 8; ++i3) {
                            worldrenderer.func_181662_b(f28 + i3 + 1.0f - 9.765625E-4f, f4 + 0.0f, f29 + 8.0f).func_181673_a((f26 + i3 + 0.5f) * 0.00390625f + f21, (f27 + 8.0f) * 0.00390625f + f22).func_181666_a(f11, f12, f13, 0.8f).func_181663_c(1.0f, 0.0f, 0.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + i3 + 1.0f - 9.765625E-4f, f4 + 4.0f, f29 + 8.0f).func_181673_a((f26 + i3 + 0.5f) * 0.00390625f + f21, (f27 + 8.0f) * 0.00390625f + f22).func_181666_a(f11, f12, f13, 0.8f).func_181663_c(1.0f, 0.0f, 0.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + i3 + 1.0f - 9.765625E-4f, f4 + 4.0f, f29 + 0.0f).func_181673_a((f26 + i3 + 0.5f) * 0.00390625f + f21, (f27 + 0.0f) * 0.00390625f + f22).func_181666_a(f11, f12, f13, 0.8f).func_181663_c(1.0f, 0.0f, 0.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + i3 + 1.0f - 9.765625E-4f, f4 + 0.0f, f29 + 0.0f).func_181673_a((f26 + i3 + 0.5f) * 0.00390625f + f21, (f27 + 0.0f) * 0.00390625f + f22).func_181666_a(f11, f12, f13, 0.8f).func_181663_c(1.0f, 0.0f, 0.0f).func_181675_d();
                        }
                    }
                    if (j2 > -1) {
                        for (int j3 = 0; j3 < 8; ++j3) {
                            worldrenderer.func_181662_b(f28 + 0.0f, f4 + 4.0f, f29 + j3 + 0.0f).func_181673_a((f26 + 0.0f) * 0.00390625f + f21, (f27 + j3 + 0.5f) * 0.00390625f + f22).func_181666_a(f17, f18, f19, 0.8f).func_181663_c(0.0f, 0.0f, -1.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + 8.0f, f4 + 4.0f, f29 + j3 + 0.0f).func_181673_a((f26 + 8.0f) * 0.00390625f + f21, (f27 + j3 + 0.5f) * 0.00390625f + f22).func_181666_a(f17, f18, f19, 0.8f).func_181663_c(0.0f, 0.0f, -1.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + 8.0f, f4 + 0.0f, f29 + j3 + 0.0f).func_181673_a((f26 + 8.0f) * 0.00390625f + f21, (f27 + j3 + 0.5f) * 0.00390625f + f22).func_181666_a(f17, f18, f19, 0.8f).func_181663_c(0.0f, 0.0f, -1.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + 0.0f, f4 + 0.0f, f29 + j3 + 0.0f).func_181673_a((f26 + 0.0f) * 0.00390625f + f21, (f27 + j3 + 0.5f) * 0.00390625f + f22).func_181666_a(f17, f18, f19, 0.8f).func_181663_c(0.0f, 0.0f, -1.0f).func_181675_d();
                        }
                    }
                    if (j2 <= 1) {
                        for (int k3 = 0; k3 < 8; ++k3) {
                            worldrenderer.func_181662_b(f28 + 0.0f, f4 + 4.0f, f29 + k3 + 1.0f - 9.765625E-4f).func_181673_a((f26 + 0.0f) * 0.00390625f + f21, (f27 + k3 + 0.5f) * 0.00390625f + f22).func_181666_a(f17, f18, f19, 0.8f).func_181663_c(0.0f, 0.0f, 1.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + 8.0f, f4 + 4.0f, f29 + k3 + 1.0f - 9.765625E-4f).func_181673_a((f26 + 8.0f) * 0.00390625f + f21, (f27 + k3 + 0.5f) * 0.00390625f + f22).func_181666_a(f17, f18, f19, 0.8f).func_181663_c(0.0f, 0.0f, 1.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + 8.0f, f4 + 0.0f, f29 + k3 + 1.0f - 9.765625E-4f).func_181673_a((f26 + 8.0f) * 0.00390625f + f21, (f27 + k3 + 0.5f) * 0.00390625f + f22).func_181666_a(f17, f18, f19, 0.8f).func_181663_c(0.0f, 0.0f, 1.0f).func_181675_d();
                            worldrenderer.func_181662_b(f28 + 0.0f, f4 + 0.0f, f29 + k3 + 1.0f - 9.765625E-4f).func_181673_a((f26 + 0.0f) * 0.00390625f + f21, (f27 + k3 + 0.5f) * 0.00390625f + f22).func_181666_a(f17, f18, f19, 0.8f).func_181663_c(0.0f, 0.0f, 1.0f).func_181675_d();
                        }
                    }
                    tessellator.draw();
                }
        ...
        if (p_180449_1_.posX >= worldborder.maxX() - d0 || p_180449_1_.posX <= worldborder.minX() + d0 || p_180449_1_.posZ >= worldborder.maxZ() - d0 || p_180449_1_.posZ <= worldborder.minZ() + d0) {
            ...
            if (d3 > worldborder.maxX() - d0) {
                ...
                for (double d8 = d6; d8 < d7; ++d8, f8 += 0.5f) {
                    ...
                    worldrenderer.func_181662_b(worldborder.maxX(), 256.0, d8).func_181673_a(f4 + f8, f4 + 0.0f).func_181675_d();
                    worldrenderer.func_181662_b(worldborder.maxX(), 256.0, d8 + d9).func_181673_a(f4 + f9 + f8, f4 + 0.0f).func_181675_d();
                    worldrenderer.func_181662_b(worldborder.maxX(), 0.0, d8 + d9).func_181673_a(f4 + f9 + f8, f4 + 128.0f).func_181675_d();
                    worldrenderer.func_181662_b(worldborder.maxX(), 0.0, d8).func_181673_a(f4 + f8, f4 + 128.0f).func_181675_d();
                }
            }
            if (d3 < worldborder.minX() + d0) {
                ...
                for (double d10 = d6; d10 < d7; ++d10, f10 += 0.5f) {
                    ...
                    worldrenderer.func_181662_b(worldborder.minX(), 256.0, d10).func_181673_a(f4 + f10, f4 + 0.0f).func_181675_d();
                    worldrenderer.func_181662_b(worldborder.minX(), 256.0, d10 + d11).func_181673_a(f4 + f11 + f10, f4 + 0.0f).func_181675_d();
                    worldrenderer.func_181662_b(worldborder.minX(), 0.0, d10 + d11).func_181673_a(f4 + f11 + f10, f4 + 128.0f).func_181675_d();
                    worldrenderer.func_181662_b(worldborder.minX(), 0.0, d10).func_181673_a(f4 + f10, f4 + 128.0f).func_181675_d();
                }
            }
            ...
            if (d5 > worldborder.maxZ() - d0) {
                ...
                for (double d12 = d6; d12 < d7; ++d12, f12 += 0.5f) {
                    ...
                    worldrenderer.func_181662_b(d12, 256.0, worldborder.maxZ()).func_181673_a(f4 + f12, f4 + 0.0f).func_181675_d();
                    worldrenderer.func_181662_b(d12 + d13, 256.0, worldborder.maxZ()).func_181673_a(f4 + f13 + f12, f4 + 0.0f).func_181675_d();
                    worldrenderer.func_181662_b(d12 + d13, 0.0, worldborder.maxZ()).func_181673_a(f4 + f13 + f12, f4 + 128.0f).func_181675_d();
                    worldrenderer.func_181662_b(d12, 0.0, worldborder.maxZ()).func_181673_a(f4 + f12, f4 + 128.0f).func_181675_d();
                }
            }
            if (d5 < worldborder.minZ() + d0) {
                ...
                for (double d14 = d6; d14 < d7; ++d14, f14 += 0.5f) {
                    ...
                    worldrenderer.func_181662_b(d14, 256.0, worldborder.minZ()).func_181673_a(f4 + f14, f4 + 0.0f).func_181675_d();
                    worldrenderer.func_181662_b(d14 + d15, 256.0, worldborder.minZ()).func_181673_a(f4 + f15 + f14, f4 + 0.0f).func_181675_d();
                    worldrenderer.func_181662_b(d14 + d15, 0.0, worldborder.minZ()).func_181673_a(f4 + f15 + f14, f4 + 128.0f).func_181675_d();
                    worldrenderer.func_181662_b(d14, 0.0, worldborder.minZ()).func_181673_a(f4 + f14, f4 + 128.0f).func_181675_d();
                }
            }
            tessellator.draw();
    ...
    public void drawSelectionBox(final EntityPlayer player, final MovingObjectPosition movingObjectPositionIn, final int p_72731_3_, final float partialTicks) {
        if (p_72731_3_ == 0 && movingObjectPositionIn.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (block.getMaterial() != Material.air && this.theWorld.getWorldBorder().contains(blockpos)) {
                ...
                func_181561_a(axisalignedbb.expand(0.0020000000949949026, 0.0020000000949949026, 0.0020000000949949026).offset(-d0, -d2, -d3));
            }
            GlStateManager.depthMask(true);
            GlStateManager.enableTexture2D();
            if (Config.isShaders()) {
