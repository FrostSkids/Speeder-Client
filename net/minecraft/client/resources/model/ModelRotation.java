...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    private ModelRotation(final String name, final int ordinal, final int p_i46087_3_, final int p_i46087_4_) {
        ...
        Matrix4f.rotate(-p_i46087_3_ * 0.017453292f, new Vector3f(1.0f, 0.0f, 0.0f), (org.lwjgl.util.vector.Matrix4f)matrix4f, (org.lwjgl.util.vector.Matrix4f)matrix4f);
        this.quartersX = MathHelper.abs_int(p_i46087_3_ / 90);
        final Matrix4f matrix4f2 = new Matrix4f();
        matrix4f2.setIdentity();
        Matrix4f.rotate(-p_i46087_4_ * 0.017453292f, new Vector3f(0.0f, 1.0f, 0.0f), (org.lwjgl.util.vector.Matrix4f)matrix4f2, (org.lwjgl.util.vector.Matrix4f)matrix4f2);
        this.quartersY = MathHelper.abs_int(p_i46087_4_ / 90);
        Matrix4f.mul((org.lwjgl.util.vector.Matrix4f)matrix4f2, (org.lwjgl.util.vector.Matrix4f)matrix4f, (org.lwjgl.util.vector.Matrix4f)this.matrix4d);
    }
    ...
    public Matrix4f getMatrix() {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? ((Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, this)) : null;
    }
