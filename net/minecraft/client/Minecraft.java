...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Speeder Client");
        try {
    ...
    private void drawSplashScreen(final TextureManager textureManagerInstance) throws LWJGLException {
        ...
        worldrenderer.func_181662_b(0.0, this.displayHeight, 0.0).func_181673_a(0.0, 0.0).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(this.displayWidth, this.displayHeight, 0.0).func_181673_a(0.0, 0.0).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(this.displayWidth, 0.0, 0.0).func_181673_a(0.0, 0.0).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(0.0, 0.0, 0.0).func_181673_a(0.0, 0.0).func_181669_b(255, 255, 255, 255).func_181675_d();
        tessellator.draw();
    ...
    public void func_181536_a(final int p_181536_1_, final int p_181536_2_, final int p_181536_3_, final int p_181536_4_, final int p_181536_5_, final int p_181536_6_, final int p_181536_7_, final int p_181536_8_, final int p_181536_9_, final int p_181536_10_) {
        ...
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.func_181662_b(p_181536_1_, p_181536_2_ + p_181536_6_, 0.0).func_181673_a(p_181536_3_ * f, (p_181536_4_ + p_181536_6_) * f2).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
        worldrenderer.func_181662_b(p_181536_1_ + p_181536_5_, p_181536_2_ + p_181536_6_, 0.0).func_181673_a((p_181536_3_ + p_181536_5_) * f, (p_181536_4_ + p_181536_6_) * f2).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
        worldrenderer.func_181662_b(p_181536_1_ + p_181536_5_, p_181536_2_, 0.0).func_181673_a((p_181536_3_ + p_181536_5_) * f, p_181536_4_ * f2).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
        worldrenderer.func_181662_b(p_181536_1_, p_181536_2_, 0.0).func_181673_a(p_181536_3_ * f, p_181536_4_ * f2).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
    ...
    private void displayDebugInfo(final long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            worldrenderer.func_181662_b(j - i * 1.1f, k - i * 0.6f - 16.0f, 0.0).func_181669_b(200, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b(j - i * 1.1f, k + i * 2, 0.0).func_181669_b(200, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b(j + i * 1.1f, k + i * 2, 0.0).func_181669_b(200, 0, 0, 0).func_181675_d();
            worldrenderer.func_181662_b(j + i * 1.1f, k - i * 0.6f - 16.0f, 0.0).func_181669_b(200, 0, 0, 0).func_181675_d();
            tessellator.draw();
            ...
            for (int l = 0; l < list.size(); ++l) {
                ...
                worldrenderer.func_181662_b(j, k, 0.0).func_181669_b(k2, l2, i3, 255).func_181675_d();
                for (int j3 = i2; j3 >= 0; --j3) {
                    ...
                    worldrenderer.func_181662_b(j + f2, k - f3, 0.0).func_181669_b(k2, l2, i3, 255).func_181675_d();
                }
                tessellator.draw();
                ...
                for (int i4 = i2; i4 >= 0; --i4) {
                    ...
                    worldrenderer.func_181662_b(j + f5, k - f6, 0.0).func_181669_b(k2 >> 1, l2 >> 1, i3 >> 1, 255).func_181675_d();
                    worldrenderer.func_181662_b(j + f5, k - f6 + 10.0f, 0.0).func_181669_b(k2 >> 1, l2 >> 1, i3 >> 1, 255).func_181675_d();
                }
                tessellator.draw();
    ...
    public void launchIntegratedServer(final String folderName, final String worldName, WorldSettings worldSettingsIn) {
        ...
        Client.getInstance().getDiscordRP().update("Playing", "Single Player");
    }
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(final CrashReport theCrash) {
        ...
        theCrash.getCategory().addCrashSectionCallable("Book", new Callable<String>() {
            @Override
            public String call() {
