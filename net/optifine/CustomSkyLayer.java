...
public class CustomSkyLayer
{
    ...
    public void render(final World world, final int timeOfDay, final float celestialAngle, final float rainStrength, final float thunderStrength) {
        ...
        if (f4 >= 1.0E-4f) {
            ...
            if (this.rotate) {
                ...
                GlStateManager.rotate(360.0f * (f5 + celestialAngle * this.speed), this.axis[0], this.axis[1], this.axis[2]);
            }
    ...
    private void renderSide(final Tessellator tess, final int side) {
        ...
        worldrenderer.func_181662_b(-100.0, -100.0, -100.0).func_181673_a(d0, d2).func_181675_d();
        worldrenderer.func_181662_b(-100.0, -100.0, 100.0).func_181673_a(d0, d2 + 0.5).func_181675_d();
        worldrenderer.func_181662_b(100.0, -100.0, 100.0).func_181673_a(d0 + 0.3333333333333333, d2 + 0.5).func_181675_d();
        worldrenderer.func_181662_b(100.0, -100.0, -100.0).func_181673_a(d0 + 0.3333333333333333, d2).func_181675_d();
        tess.draw();
    }
