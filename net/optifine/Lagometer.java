...
public class Lagometer
{
    ...
    private static long renderTime(final int frameNum, final long time, final int r, final int g, final int b, final float baseHeight, final WorldRenderer tessellator) {
        ...
        tessellator.func_181662_b(frameNum + 0.5f, baseHeight - i + 0.5f, 0.0).func_181669_b(r, g, b, 255).func_181675_d();
        tessellator.func_181662_b(frameNum + 0.5f, baseHeight + 0.5f, 0.0).func_181669_b(r, g, b, 255).func_181675_d();
        return i;
    }
    ...
    private static long renderTimeDivider(final int frameStart, final int frameEnd, final long time, final int r, final int g, final int b, final float baseHeight, final WorldRenderer tessellator) {
        ...
        tessellator.func_181662_b(frameStart + 0.5f, baseHeight - i + 0.5f, 0.0).func_181669_b(r, g, b, 255).func_181675_d();
        tessellator.func_181662_b(frameEnd + 0.5f, baseHeight - i + 0.5f, 0.0).func_181669_b(r, g, b, 255).func_181675_d();
        return i;
    }
