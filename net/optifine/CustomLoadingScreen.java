...
public class CustomLoadingScreen
{
    ...
    public void drawBackground(final int width, final int height) {
        ...
        worldrenderer.func_181662_b(0.0, height, 0.0).func_181673_a(d4, d5 + d3).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(width, height, 0.0).func_181673_a(d4 + d2, d5 + d3).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(width, 0.0, 0.0).func_181673_a(d4 + d2, d5).func_181669_b(255, 255, 255, 255).func_181675_d();
        worldrenderer.func_181662_b(0.0, 0.0, 0.0).func_181673_a(d4, d5).func_181669_b(255, 255, 255, 255).func_181675_d();
        tessellator.draw();
    }
}
