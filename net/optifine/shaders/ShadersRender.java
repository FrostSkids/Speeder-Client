...
public class ShadersRender
{
    ...
    public static boolean renderEndPortal(final TileEntityEndPortal te, final double x, final double y, final double z, final float partialTicks, final int destroyStage, final float offset) {
        ...
        final int i = 240;
        worldrenderer.func_181662_b(x, y + offset, z + 1.0).func_181666_a(f2, f3, f4, 1.0f).func_181673_a(f5 + f7, f5 + f7).func_181671_a(i, i).func_181675_d();
        worldrenderer.func_181662_b(x + 1.0, y + offset, z + 1.0).func_181666_a(f2, f3, f4, 1.0f).func_181673_a(f5 + f7, f6 + f7).func_181671_a(i, i).func_181675_d();
        worldrenderer.func_181662_b(x + 1.0, y + offset, z).func_181666_a(f2, f3, f4, 1.0f).func_181673_a(f6 + f7, f6 + f7).func_181671_a(i, i).func_181675_d();
        worldrenderer.func_181662_b(x, y + offset, z).func_181666_a(f2, f3, f4, 1.0f).func_181673_a(f6 + f7, f5 + f7).func_181671_a(i, i).func_181675_d();
        tessellator.draw();
